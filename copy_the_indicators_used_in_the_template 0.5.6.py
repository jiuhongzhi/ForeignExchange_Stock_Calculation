...
'''建立模板内指标备份处理Python程序文件备份文件夹'''
py_path = drive + 'forex_python_常用'                           # Python程序备份文件夹
if os.path.exists(py_path):                                     # 备份文件夹存在
    message = 'The %s folder already exists.'
    print(message % py_path)                              # 显示
else:                                                           # Python程序备份文件夹不存在
    os.mkdir(py_path)                                           # 创建文件夹
    message = 'The %s folder was not created. Now create the %s folder.'
    print(message % (py_path, py_path))                   # 显示
print('Python程序备份文件夹: ' + py_path + '\n')
mq4ex4_files += '(Python程序备份文件夹: ' + py_path + ')\n\n'    # 记录Python程序备份文件夹位置
...
for line in result:
    ...
    if line.find('.py') >= 0:                                   # '.py'存在
        ...
        print('    ' + sourcefile)                    # 显示
        mq4ex4_files += '    ' + sourcefile + '\n'              # 加入此文件名
        t = shutil.copy2(py_sourcefile_path+'\\'+sourcefile, py_path + '/')  # 复制Python程序文件
