...
def run_main():
    ...
    mq4ex4_files = create_backup_folder(s__path, description, mq4ex4_files)  # 建立脚本备份文件夹及显示、记录信息

    '''备份MT5-EA文件夹及说明'''
    backup_folder = 'MT5_Experts_常用'
    description = 'MT5 EA备份文件夹: '
    mt5_e_path = general_path + '\\' + backup_folder                   # MT5 EA备份文件夹路径
    mq4ex4_files = create_backup_folder(mt5_e_path, description, mq4ex4_files)  # 建立MT5 EA备份文件夹及显示、记录信息
    ...
    mq4ex4_files = create_backup_folder(py_path, description, mq4ex4_files)  # 建立Python程序备份文件夹及显示、记录信息

    '''建立Visio流程图备份文件夹及说明'''
    backup_folder = 'Visio_file_常用'
    description = 'Visio流程图备份文件夹: '
    visio_path = general_path + '\\' + backup_folder                # Visio流程图备份文件夹路径
    mq4ex4_files = create_backup_folder(visio_path, description, mq4ex4_files) + '\n'  # 建立Visio流程图备份文件夹及显示、记录信息
    ...
    mq4ex4_files += '\n备份的特殊指标文件:\n'
    mq4ex4_files += '    ' + indicators_file                        # 加入特殊指标文件名
    '''部分特殊脚本文件备份'''
