...
def run_main():
    ...
    '''部分MQL5特殊头文件备份'''
    mq5_expert_file = 'a_Expert.mqh'
    shutil.copy2(path5+'\\MQL5\\Include\\Expert\\' + mq5_expert_file, mt5_e_path + '/')  # 复制MQL5特殊头文件
    print('备份的MQL5特殊头文件:')
    print('    ' + mq5_expert_file)                             # 显示
    mqex_files += '\n备份的MQL5特殊头文件:\n'
    mqex_files += '    ' + mq5_expert_file                          # 加入MQL5特殊头文件名
    '''部分MQL5特殊指标文件备份'''
    mq5_indicators_file = 'Bars_numeration.mq5'
    shutil.copy2(path5+'\\MQL5\\Indicators\\' + mq5_indicators_file, mt5_i_path + '/')  # 复制MQL5特殊指标文件
    print('备份的MQL5特殊指标文件:')
    print('    ' + mq5_indicators_file + '\n')                  # 显示
    mqex_files += '\n备份的MQL5特殊指标文件:\n'
    mqex_files += '    ' + mq5_indicators_file + '\n\n'             # 加入MQL5特殊指标文件名
