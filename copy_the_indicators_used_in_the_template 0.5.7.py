...
def run_main():
    ...
    for line in result:
        ...
        if line.find('.mq4') >= 0 or line.find('.ex4') >= 0:        # '.mq4'或'.ex4'存在
            ...
            shutil.copy2(path+'\\MQL4\\Experts\\'+sourcefile, e_path + '/')  # 复制EA文件
    '''遍历EA文件结束,加入EA文件总数'''
